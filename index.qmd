...
**Note:** Quarto can be [installed](https://quarto.org/docs/get-started/){target="_blank"} and used without R or RStudio, e.g., with VS Code, etc. But this workshop demonstrates the use of RStudio and includes some R code.
